        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="form-horizontal" class="form-horizontal form-wizard-wrapper" method="POST" action="{{ route('students.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <fieldset>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="txtFirstNameBilling" class="col-lg-3 col-form-label">Firstname</label>
                                        <div class="col-lg-9">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input id="txtEmailAddressBilling" name="dateOfBirth"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="txtCityBilling" class="col-lg-3 col-form-label">Region of residence</label>
                                        <div class="col-lg-9">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="txtStateProvinceBilling" class="col-lg-3 col-form-label">Postal Address
                                            </label>
                                        <div class="col-lg-9">
                                            <input id="txtStateProvinceBilling" name="postalCode"
                                                type="text" class="form-control">
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="txtTelephoneBilling" class="col-lg-3 col-form-label">Name of Parent</label>
                                        <div class="col-lg-9">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="txtFaxBilling" class="col-lg-3 col-form-label">Parent Phonenumber</label>
                                        <div class="col-lg-9">
                        ...
                        <fieldset>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="txtFirstNameShipping" class="col-lg-3 col-form-label">Name of Secondary School</label>
                                        <div class="col-lg-9">
                                            <input id="txtFirstNameShipping" name="o_level_school_name" type="text"
                                                type="text" class="form-control">
                                        </div>
                                    </div><!--end form-group-->
                                </div><!--end col-->
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="txtLastNameShipping" class="col-lg-3 col-form-label">Secondary Location</label>
                                        <div class="col-lg-9">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="txtCompanyShipping" class="col-lg-3 col-form-label">Name of HighSchool</label>
                                        <div class="col-lg-9">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="txtEmailAddressShipping" class="col-lg-3 col-form-label">High School Location</label>
                                        <div class="col-lg-9">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="secondary_certificate" id="" class="form-control" placeholder="" aria-describedby="helpId">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                      ...
                                      <input type="file" name="high_school_certificate" id="" class="form-control" placeholder="" aria-describedby="helpId">
                                      <small id="helpId" class="text-muted"></small>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                      ...
                                      <input type="file" name="diploma_certificate" id="" class="form-control" placeholder="" aria-describedby="helpId">
                                      <small id="helpId" class="text-muted"></small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="txtCityShipping" class="col-lg-3 col-form-label">Diploma Corse</label>
                                        <div class="col-lg-9">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input id="txtStateProvinceShipping" name="universit_name"
                                                type="text" class="form-control">
                                        </div>
                                    </div><!--end form-group-->
                                </div><!--end col-->
                        ...
                        <fieldset>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="ddlCreditCardType" class="col-lg-3 col-form-label">Select Course</label>
                                        <div class="col-lg-9">
                                            <select id="" name="" class="select2 form-control mb-3 custom-select">
...
<footer class="footer text-center text-sm-left">
    &copy; 2014 <span class="text-muted d-none d-sm-inline-block float-right">Developed<i class="mdi mdi-heart text-danger"></i>kevoocodes</span>
</footer><!--end footer-->
</div>
<!-- end page content -->
</div>
...
<link href="https://mannatthemes.com/metrica_mvc5/plugins/select2/select2.min.css" rel="stylesheet" type="text/css" />
