                        ...
                        <div class="card auth-card shadow-lg">
                            <div class="card-body">
                                    ...
                                    <form class="form-horizontal auth-form my-4" action="https://mannatthemes.com/metrica_mvc5/default/index.html">
                                        ...
                                        <div class="form-group row mt-4">
                                            ...
                                            <div class="col-sm-6 text-right">
                                                <a href="{{route('forgot-password.students')}}" class="text-muted font-13"><i class="dripicons-lock"></i> Forgot password?</a>                                    
                                            </div><!--end col--> 
                                        </div><!--end form-group--> 
                                ...
                                <div class="m-3 text-center text-muted">
                                    <p class="">Don't have an account ?  <a href="{{ route('register.students') }}" class="text-primary ml-2">Free Resister</a></p>
                                </div>
                            </div><!--end card-body-->
                        </div><!--end card-->
